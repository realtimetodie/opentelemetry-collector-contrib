...
* `split_logs_json_array` (default: false): If true, the receiver will parse the request body as JSON and create a separate log record for each element in the array.
